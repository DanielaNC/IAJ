...
namespace Assets.Scripts.IAJ.Unity.DecisionMaking.BehaviorTree.EnemyTasks
{
    class HearOrcScream : Task
    {
        ...
        public override Result Run()
        {
            ...
            if (GameObject.FindObjectOfType<GameManager>().orcScream == true && character.hasScreamed == false)
            {
                character.MoveTo((GameObject.FindObjectOfType<GameManager>().orcScreamPosition));
